test_that("conda, use, 'last' is not installed", {
...
test_that("conda, use, check versions", {
  expect_equal(1 + 1, 2) # Prevents testthat warning for empty test
  if (!is_conda_installed()) return()
...
test_that("no conda, use, 'last' is not installed", {
...
test_that("no conda, use, check versions", {
  ormr_folder_name <- "python3"
  t <- get_installed_python_packages(ormr_folder_name = ormr_folder_name)
